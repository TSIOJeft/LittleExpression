...
/**
 * Created by Fan on 2018/2/11.
 */

public class Page6 extends Fragment {
    private LayoutInflater layoutInflater;
    private ArrayList<BitmapDrawable>data6=new ArrayList<>();
    private String pathname="zx";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerviewAdapter adapter = new RecyclerviewAdapter(getContext(), data6);
        ...
        new Thread() {
            ...
            public void run() {
                data6.clear();
                data6.addAll(getImages(getContext(),pathname));
        ...
        adapter.setOnRecyclerViewClickListener(new RecyclerviewAdapter.OnRecyclerViewClickListener() {
            ...
            public void OnItemClick(View view, final int p) {
                ...
                image_dialog.setImageDrawable(data6.get(p));
                        ...
                        .onNeutral(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                if (checkPermission(getActivity())) {
                                    save(data6.get(p), names[p], getActivity());
                                }
                                ;
                            }
                        })
