...
public class Page1 extends Fragment {
    private ArrayList<BitmapDrawable> data1 = new ArrayList<>();
    private LayoutInflater layoutInflater;
    private String pathname="xhh";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        final RecyclerviewAdapter adapter = new RecyclerviewAdapter(getContext(), data1);
        ...
        new Thread() {
            ...
            public void run() {
                data1.clear();
                data1.addAll(getImages(getContext(),pathname));
        ...
        adapter.setOnRecyclerViewClickListener(new RecyclerviewAdapter.OnRecyclerViewClickListener() {
            ...
            public void OnItemClick(View view, final int p) {
                ...
                image_dialog.setImageDrawable(data1.get(p));
                        ...
                        .onNeutral(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                if(checkPermission(getActivity())){
                                    save(data1.get(p),names[p],getActivity());
                                };
                            }
                        })
                        .show();
...
//                String[] xmrs = assets.list("xhh");
//                for (String xmr : xmrs) {
//                    InputStream image = assets.open("xhh/" + xmr);
//
