...
public class Page2 extends Fragment {
    private ArrayList<BitmapDrawable>data2=new ArrayList<>();
    private LayoutInflater layoutInflater;
    private String pathname="xws";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerviewAdapter adapter = new RecyclerviewAdapter(getContext(), data2);
        ...
        new Thread() {
            ...
            public void run() {
                data2.clear();
                data2.addAll(getImages(getContext(),pathname));
        ...
        adapter.setOnRecyclerViewClickListener(new RecyclerviewAdapter.OnRecyclerViewClickListener() {
            ...
            public void OnItemClick(View view, final int p) {
                ...
                image_dialog.setImageDrawable(data2.get(p));
                        ...
                        .onNeutral(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                if(checkPermission(getActivity())){
                                    save(data2.get(p),names[p],getActivity());
                                };
                            }
                        })
                        .show();
