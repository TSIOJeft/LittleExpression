...
public class Page4 extends Fragment {
    ...
    private ArrayList<BitmapDrawable>data4=new ArrayList<>();
    private String pathname="xhg";
    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final RecyclerviewAdapter adapter = new RecyclerviewAdapter(getContext(), data4);
        ...
        new Thread() {
            ...
            public void run() {
                data4.clear();
                data4.addAll(getImages(getContext(),pathname));
        ...
        adapter.setOnRecyclerViewClickListener(new RecyclerviewAdapter.OnRecyclerViewClickListener() {
            ...
            public void OnItemClick(View view, final int p) {
                ...
                image_dialog.setImageDrawable(data4.get(p));
                        ...
                        .onNeutral(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                if (checkPermission(getActivity())) {
                                    save(data4.get(p), names[p], getActivity());
                                }
                                ;
                            }
                        })
